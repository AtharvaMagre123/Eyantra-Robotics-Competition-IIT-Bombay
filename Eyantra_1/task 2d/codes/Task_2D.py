...
def write_csv(loc, csv_name):
    ...
    with open(csv_name, mode='w', newline='') as file:
        ...
        writer.writerow(['lat', 'lon'])  # Writing column headers
        writer.writerow(loc)  # Writing loc data to respective columns
...
def tracker(ar_id, lat_lon):
    ...
    if ar_id in lat_lon:
        ...
        # Handle the case when ar_id is not found, return a default value
        return [0, 0]

# Add print statements in the main loop
